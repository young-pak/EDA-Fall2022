...
matrix1[ , 3] #
matrix1[c(12, 14)] # 
matrix1[c(12:14)] #slice: range of values 
matrix1[2:4, 1:3] # 
...
```{r DataExercise-1a}
vector1 <- c(93,73,78,85,82,78,75,73,71,76)
vector2 <-c(53,48,59,61,54,51,51,52,55,55) 
...
```{r DataExercise-1b}
vector3 <- (vector1-32)*(5/9)
vector4 <- (vector2-32)*(5/9)
c_high <- round(vector3,digit=0)
c_low <- round(vector4,digit=0)
...
```{r DataExercise-1c}
tendayforecast <- data.frame(vector1,vector2,c_high,c_low) #
names(tendayforecast) <- c("F_high","F_low","C_high", "C_low"); View(tendayforecast)
```
...
```{r DataExercise-1d}
summary(tendayforecast)
sd(vector1)
sd(tendayforecast$"F_high")
summary(tendayforecast$"F_low")
```
